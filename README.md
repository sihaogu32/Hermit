...
| 移植來源（citation-guard / legal-kb-admin）參考 | [`docs/port-sources/`](docs/port-sources/) |
| 目錄責任邊界、Extension Slots | [`wiki/project-structure.md`](wiki/project-structure.md) |
| Wiki 自身規則 | [`wiki/SCHEMA.md`](wiki/SCHEMA.md) |
